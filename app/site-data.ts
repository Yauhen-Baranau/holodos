...
export const serviceClusters = {
  ...
  brands: {
    ...
    lead: "Отдельный кластер страниц по брендам холодильников: подбираем решение с учетом модели, системы управления и типовых неисправностей конкретной марки.",
  ...
  regions: {
    ...
    lead: "Региональный кластер с направлениями выезда мастера по Минской области: выбирайте населенный пункт и смотрите условия ремонта холодильника на дому.",
