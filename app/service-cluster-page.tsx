      ...
      <main>
        ...
        {cluster.slug === "regions" ? (
          <>
            <RegionCards
              title="Районы Минска"
              description="Выезд мастера по районам и микрорайонам Минска: Уручье, Малиновка, Сухарево, Серебрянка, Лошица, Каменная Горка, Чижовка, Зелёный Луг, Восток и административные районы."
